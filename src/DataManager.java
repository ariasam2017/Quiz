...
public class DataManager {
        ...
        try {
            ...
            while (fileScanner.hasNextLine()) {
                ...
                if (typeString.equalsIgnoreCase("سنگی") || typeString.equalsIgnoreCase("سنگ") || typeString.equalsIgnoreCase("Rock")) {
                    ...
                    System.out.println("نوع سیاره نامعتبر در فایل دادهها: " + typeString);
                    continue;
                }
            ...
            System.out.println("خطا در خواندن فایل دادهها: " + e.getMessage());
        }
    }
    ...
    public static void saveData(ArrayList<Galaxy> galaxies, String filename) {
        try {
            ...
            System.out.println("خطا در ذخیرهسازی فایل دادهها: " + e.getMessage());
        }
    }
