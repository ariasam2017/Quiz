...
public class MainApp {
    ...
    private static void addNewPlanet() {
        ...
        if (findPlanetByName(name) != null) {         // بررسی تکراری نبودن نام سیاره
            System.out.println("سیارهای با این نام قبلاً وجود دارد. لطفاً نام دیگری انتخاب کنید.\n");
            return;
        }
    ...
    private static void changeMoonCount() {
        ...
        if (planet != null) {
            ...
            System.out.println("سیارهای با این نام یافت نشد.\n");
        }
    }
